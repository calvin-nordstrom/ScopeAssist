...
* **Monitor Selection** – Choose which display the scope appears on
* **Radius** – Adjustable size of the scope (50–500 pixels)
* **Magnification** – Zoom level from 1.0x to 10.0x
* **Activation Type**
  * *Hold* – Active only while input is pressed
...
* **Monitor Selection** – Choose which display the reticle appears on
* **Radius** – Reticle size (1.0–10.0 pixels)
...
* Hardcore / mil-sim shooters with no HUD
* Games without a visible crosshair
